...
export default function HeroSection() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const createParticles = () => {
        ...
        // Create different types of particles with improved aesthetics
        for (let i = 0; i < 60; i++) {
          ...
          // More complex and varied animations
          gsap.to(particle, {
      ...
      // Initialize animations with master timeline
  ...
  return (
    ...
    >
      ...
      {/* Abstract background shapes with improved positioning and effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right side video showcase with improved card design */}
          <div className="relative flex justify-center items-center z-10">
            <div className="video-card-container relative overflow-visible w-full max-w-lg">
              {/* Enhanced background cards for 3D effect */}
        ...
        <div className="relative">
          {/* Thumbnail Image */}
          <Image
            src="/images/video/thumbnail.png" // Replace with your actual image path
            alt="Video Thumbnail"
            width={800}
            height={450}
        ...
        />
                ...
                {/* Video information with improved layout */}
                <div className="p-6">
