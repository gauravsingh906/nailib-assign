...
<section 
  ref={testimonialRef} 
  className="relative py-24 px-6 mb-16 lg:px-8 h-auto overflow-hidden bg-gradient-to-br from-white to-blue-50"
>
  {/* Decorative elements */}
  ...
  <div className="max-w-6xl mx-auto relative z-10">
    <div className="text-center mb-16">
      <div className="inline-block mb-3 relative">
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-blue-500 text-4xl md:text-5xl font-extrabold relative z-10 font-['IntegralCF-Bold']">
          Student Success
        </span>
        <div className="absolute -bottom-2 left-0 right-0 h-3 bg-blue-200 opacity-70 transform skew-x-12"></div>
      </div>
      <h2 className="text-2xl md:text-3xl text-gray-800 font-light mb-8 font-['IntegralCF-Regular']">Transforming <span className="text-blue-600 font-semibold">IB Education</span></h2>
      <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-['Open_Sans']">
    ...
    <div className="relative mt-12 min-h-[500px] overflow-auto md:overflow-visible">
          ...
          >
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              <div className="flex-shrink-0 relative order-1 md:order-1">
                ...
                <div 
                  className="absolute -bottom-3 -right-2 rounded-full py-1 px-3 text-xs font-bold font-['Open_Sans-Bold']"
                  style={{
                    background: "white",
              ...
              <div className="order-2 md:order-2 text-center md:text-left">
                ...
                <p className="text-xl text-gray-700 mb-6 leading-relaxed relative font-['Open_Sans']">
                ...
                <div className="mt-6 bg-blue-50 p-4 rounded-xl inline-block">
                  <h4 className="font-bold text-lg text-gray-800 font-['IntegralCF-Bold']">{testimonial.name}</h4>
                  <p className="text-gray-600 font-['Open_Sans']">{testimonial.role}</p>
                  <div 
                    className="inline-block mt-2 py-1 px-3 rounded-full text-sm font-medium font-['Open_Sans-Bold']"
                    style={{
      ...
      <div className="flex flex-col items-center mt-8 space-y-4">
        ...
        <button
          className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-colors font-['Open_Sans-Bold'] ${
