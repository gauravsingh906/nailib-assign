...
export default function FAQSection() {
  ...
  return (
    <section 
      ref={faqRef} 
      className="py-24 font-[IntegralCF] px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col font-[IntegralCF] sm:flex-row items-center justify-center gap-4">
