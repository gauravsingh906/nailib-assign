...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    "Subjects": [
      ...
      { name: "View All", href: "/subjects" }
    ],
    "Resources": [
      { name: "Blog", href: "/blog" },
      { name: "Study Guides", href: "/study-guides" },
      { name: "IB Calendar", href: "/ib-calendar" },
    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
      ...
      />
            ...
            <p className="text-gray-400 mb-6">
              Empowering IB students worldwide with innovative study tools and resources.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Nailib. All rights reserved.
            </p>
