...
const VideoSection = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="bg-gradient-to-b from-gray-50 to-gray-100 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden relative"
    >
            ...
            {activeVideo ? (
              ...
              <div className="aspect-video bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 flex items-center justify-center text-white">
                <div className="text-center p-8 max-w-md">
                  ...
                  <h3 className="text-2xl font-bold mb-3">Discover IB Excellence</h3>
                ...
                {filteredVideos.map((video) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-semibold text-gray-900 truncate leading-tight">{video.title}</h4>
          ...
          <div className="relative mt-16 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 overflow-hidden shadow-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                <button className="bg-white text-blue-600 hover:bg-blue-50 font-bold py-3 px-6 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 ">
                  Start Free Trial
                </button>
                <button className="bg-blue-800/30 text-white hover:bg-blue-800/50 font-bold py-3 px-6 rounded-lg transition-all duration-300 ">
                  View Plans
                </button>
              </div>
            </div>
